...
public class FXMLDocumentController implements Initializable 
{
    ...
    private final String path = "C:\\Users\\balak\\Documents\\NetBeansProjects"
                        + "\\CSC600_HealthAssessment\\src\\csc600_healthassessment\\";
    ...
    private void handleSave(ActionEvent event) 
    {
        try 
        {
            ...
            else if ( patientNameText.getText().matches("[a-zA-Z\\s]*$") )
            {
                ...
                {
                    m_fileName = patientNameText.getText();
                    m_obj = new HealthApp(path + m_fileName + ".txt");
